...
describe("Frame component", () => {
  ...
  it("should display strike in roll2, if roll2 and roll1 value is 10", () => {
    const wrapper = shallow(
      <Frame index={10} roll1={10} roll2={10} roll3={5} />
    );
    const roll2 = wrapper.find(".frame span").at(1).text();
  ...
  it("should display strike in roll3, if roll1, roll2 and roll3 values are 10", () => {
    const wrapper = shallow(
      <Frame index={10} roll1={10} roll2={10} roll3={10} />
    );
    const roll3 = wrapper.find(".frame span").at(2).text();
  ...
  it("should display spare in roll3, if roll1 is strike and sum of roll2 and roll3 is 10", () => {
    const wrapper = shallow(
      <Frame index={10} roll1={10} roll2={7} roll3={3} />
    );
    const roll3 = wrapper.find(".frame span").at(2).text();
